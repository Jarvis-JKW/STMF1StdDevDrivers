/**
  ...
  *  See included License.txt for License information.
  $
  ******************************************************************************
  * @file       /Hardware/src/inv_mpu.c
  * @author     InvenSense Corporation
  * @version    Unknown
  * @date       4-Feb-2022(modify)
  * @brief      An I2C-based driver for Invensense gyroscopes.
  ******************************************************************************
  * @attention  This driver currently works for the following devices:
  *             MPU6050
  *             MPU6500
...
#define i2c_write(slave_addr, reg_addr, length, data)   !IIC_WriteBytes(&IIC2, slave_addr<<1, reg_addr, data, length)
#define i2c_read(slave_addr, reg_addr, length, data)    !IIC_ReadBytes(&IIC2, slave_addr<<1, reg_addr, data, length)
...
/* Customed Edit functions for STM32F1 ---------------------------------------*/
...
/**
  * @brief  陀螺仪方向控制
  * @param  mtx: gyro_orientation matrix
  * @retval Gyro and accel orientation in body frame
  */
...
//方向转换
unsigned char inv_row_2_scale(const signed char *row)
{
    if(row[0] > 0)      return 0;
