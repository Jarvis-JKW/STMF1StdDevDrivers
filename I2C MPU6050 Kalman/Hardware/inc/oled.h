...
//-----------------OLED端口定义---------------- 
#define OLED_WriteCmd(cmd)      I2C_Write(I2C2, OLED_ADDR, 0x00, cmd)
#define OLED_WriteData(data)    I2C_Write(I2C2, OLED_ADDR, 0x40, data)
#define OLED_WritePage(arr)     I2C_WriteBytes(I2C2, OLED_ADDR, 0x40, arr, 128)
